...
src/
  ...
  js/                      ES6 modules for client-side application logic
    ...
    body-profile.js        BMR / TDEE calculations
    analytics.js           macro breakdown & history trends
    vision.js              photo analysis & label OCR workflow
    ui-modals.js           modal & navigation handlers
    label-ocr-parser.js    nutrition label OCR regex parser
api/                       serverless API routes for Vercel / server execution
  lookup.js                text -> Groq lookup
